...
del imr\matrix\*.java imr\plot\*.java imr\sound\*.java imr\sound\audio\*.java imr\sound\audio\analysis\*.java imr\sound\audio\synthesis\*.java imr\sound\audio\window\*.java imr\sound\midi\*.java imr\util\*.java
