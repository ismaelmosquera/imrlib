...
* A <code>MusicalSynthesizer</code> uses an object of this class and an envelope to perform its task.
*
* @see imr.sound.audio.synthesis.MusicalSynthesizer
...
{
	_wave[i] = (byte)(0.25 * sum[i] * 127.0f);
}
_mustUpdate = false;
}
