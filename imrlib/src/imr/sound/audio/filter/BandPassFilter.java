...
/**
* The <code>BandPassFilter</code> class implements a filter allowing to pass frequencies for a concrete band [MinHz .. MaxHz].
* <p>
...
*
*/
public final class BandPassFilter extends Filter
{

/**
* Constructor.
* <p>
* Makes a new instance for a <code>BandPassFilter</code> object.
*
*/
...
*
*/
public BandPassFilter(float sr, float cf, Range band, int size)
{
