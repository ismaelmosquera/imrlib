...
/**
* The <code>HighPassFilter</code> class implements a filter allowing to pass frequencies above a concrete cut-off frequency.
* <p>
...
*
*/
public final class HighPassFilter extends Filter
{

/**
* Constructor.
* <p>
* Makes a new instance for a <code>HighPassFilter</code> object.
*
*/
...
*
*/
public HighPassFilter(float sr, float cf, Range band, int size)
{
