...
* @param fromRow From row number
* @param toRow To row index
* @param fromCol From column number
* @param toCol To column number
...
* @param fromI From i index
* @param toI To i index
* @param fromJ From j index
* @param toJ To j index
* @param fromK From k index
* @param toK To k index
...
* @param newSize New size of the result array
...
* @param c 3-dimensional array to resize
* @param i New I-size
* @param j New J-size
* @param k New K-size
