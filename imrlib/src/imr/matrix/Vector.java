...
for(int i=0;i<size;i++) vector[i] += v.get(i);
}
...
/**
* Multiplies a vector one-to-one by the value passed as parameter.
* @param value a value to multiply.
*/
...
/**
* Divides a vector one-to-one by the value passed as parameter.
* @param value a value to divide.
*/
...
/**
* Static method to multiply a vector one-to-one by a value.
* @param v a vector.
* @param value a value to multiply.
* @return v.*value
*/
public static Vector mul(Vector v,double value)
{
...
/**
* Static method to divide a vector one-to-one by a value.
* @param v a vector.
* @param value a value to divide.
* @return v./value
*/
public static Vector div(Vector v,double value)
{
	if(value == 0) return v;
	Vector r = new Vector(v.size());
	for(int i=0;i<r.size();i++)
