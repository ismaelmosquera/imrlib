...
* <p>
* @return Resulting matrix or <code>this</code> if the column cannot be set.
*
*/
public Matrix setColumn(Vector v, int column)
{
if(v == null) return this;
	if(column < 0 || column > this.columns()-1) return this;
	if(v.size() != this.rows()) return this;
	Matrix out = (Matrix)this.clone();
	for(int i = 0; i < out.rows(); i++)
	{
		out.set(i, column, v.get(i));
	}
	return out;
}
