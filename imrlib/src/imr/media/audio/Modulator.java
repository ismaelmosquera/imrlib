...
/**
* Gets the modulator amplitude.
*
* @return amplitude value
*/
public float getModulatorAmplitude()
{
return _modulator.getAmplitude();
}

/**
* Gets the modulator frequency.
*
* @return frequency value
*/
public float getModulatorFrequency()
{
return _modulator.getFrequency();
}
...
{
	if(_modulationIndex == 0.0f || _wave.getAmplitude() == 0.0f)
	{
...
{
	if(_modulationIndex == 0.0f || _wave.getAmplitude() == 0.0f || getMax(data) == 0.0f) return;
