 ...
 * </ul>
 * The <code>Carrier</code> class is used in the <code>AMInstrument</code> class, as you will see later.
 * The <code>MusicalInstrument</code> class implements a basic instrument.
 *
 * <code>Modulator</code>
 * This class implements a component which modulates the signal passed as parameter to its main method (modulate).
 * This class, in combination with the <code>Carrier</code> one are used to implement an am instrument.
 * That is, the modulator modulates the carrier in order to perform am synthesis.
 *
 * <code>AMInstrument</code>
 * This class implements a basic AM synthesizer with just 2 operators:
 * <ul>
 * <li>Carrier</li>
 * <li>Modulator</li>
 * </ul>
 ...
 *
 * <code>FMInstrument</code>
 * This class implements an instrument suitable to perform fm synthesis.
 * It has an oscillator as a carier and an inner class as modulator.
 * As in the case of <code>AMInstrument</code> you can set several wave types to modulate the carier signal.
 *
