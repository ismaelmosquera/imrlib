 ...
 *
 * <code>WaveType</code>
 * This class just have 3 public fields useful to set a possible desired wave.
 *
 ...
 * </ul>
 * The <code>Carrier</code> class is used in the <code>FMInstrument</code> class, as you will see later.
 ...
 * This class, in combination with the <code>Carrier</code> one are used to implement an fm instrument.
 * That is, the modulator modulates the carrier in order to perform fm synthesis.
 *
 * <code>FMInstrument</code>
 * This class implements a basic FM synthesizer with just 2 operators:
 * <ul>
 * <li>Carrier</li>
 * <li>Modulator</li>
 * </ul>
 * You can set the modulator wave type to modulate the carrier.
 * That is: saw, sine or triangular.
 *
