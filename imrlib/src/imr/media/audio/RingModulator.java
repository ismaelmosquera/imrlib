...
/**
* The <code>RingModulator</code> class performs ring modulation synthesis.
...
*
*/
public class RingModulator extends Modulator
{
...
*
*/
public RingModulator(float amp, float freq, float sr)
{
	super(amp, freq, sr);
}
...
_modulator.applyRingModulation(frame);
}
