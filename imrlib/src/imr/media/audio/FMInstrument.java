...
/**
* The <code>FMInstrument</code> class performs fm synthesis.
* It encapsulates an <code>Oscillator</code> object and its associated <code>Envelope</code> object.
* In order to perform fm synthesis, an inner class was implemented.
...
*
*/
public FMInstrument(float amp, float freq, float sr)
{
_carrier = new Oscillator(amp, freq, sr);
_modulator = new FModulator(amp, freq, _carrier.getSampleRate());
...
private int getCEnvDuration(int size)
{
...
private boolean _applyCEnv;
private Envelope _cenv;
private Oscillator _carrier;
private FModulator _modulator;


/**
* The <code>FModulator</code> class implements a signal modulator.
* This class is needed to perform fm synthesis.
...
*
*/
public FModulator(float amp, float freq, float sr)
{
	_wave = null;
...
/**
* This method builds the modulator signal.
