...
/*
* These protected abstract methods are useful to map x and y coordinates from logical to phicical ones.
* The parameters are self explanatory, but you can get more information looking in the documentation of a subclass.
*
* See imr.plot.DataRenderer a subclass of Renderer
*
*/
protected abstract float getX(float x, int width);
protected abstract float getY(float y, int height);
