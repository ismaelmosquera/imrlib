...
import imr.sound.audio.filter.LowPassFilter;
...
System.out.println("Saving audio file ... -> ../../sound/low_pass.wav");
...
AudioInputStream output = new AudioInputStream(new ByteArrayInputStream(buffer.toByteArray()), input.getFormat(),
	...
	try
	{
	AudioFileIO.store(output, "../../sound/low_pass.wav");
}
catch(UnsupportedAudioFileException e)
{
	e.printStackTrace();
...
private static final float CUT_OFF_FREQUENCY = 500.0f;
