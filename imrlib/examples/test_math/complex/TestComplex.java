...
System.out.println();
c1.setReal(1.0/8.0*Math.PI);
c1.setImag(1.0);
System.out.println("sin(" + c1 + ") = " + c1.sin());
System.out.println("asin" + c1.sin() + " = " + c1.sin().asin());
System.out.println("cos(" + c1 + ") = " + c1.cos());
System.out.println("acos" + c1.cos() + " = " + c1.cos().acos());
System.out.println("tan(" + c1 + ") = " + c1.tan());
System.out.println("atan" + c1.tan() + " = " + c1.tan().atan());
System.out.println();
c1.setReal(3.0);
c1.setImag(4.0);
z = c1.log();
...
c1.setReal(1000000.0);
System.out.println("log10(" + c1 + ") = " + c1.log10());
c1.setReal(1.0f/100.0);
System.out.println("log10(" + c1 + ") = " + c1.log10());
c1.setReal(2.0);
c1.setImag(1.0);
z = c1.square();
...
System.out.println("e^(iPI) = " + ComplexNumber.eulerIdentity(Math.PI));
System.out.println();
