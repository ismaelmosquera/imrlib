...
public void play()
{
	...
	_fm.getModulator().setAmplitude(0.8f);
	_fm.getModulator().setEnvADSR(5, 20, 60, 15);
	_fm.getModulator().setEnvSustainLevel(0.4f);
...
_fm.getModulator().setFrequency(f[i]*3.0f);
_fm.synth(frame);
}
_player.play(frame);
_saver.add(frame);
