...
import imr.sound.audio.synthesis.WaveType;
import imr.sound.audio.synthesis.Modulator;
import imr.sound.audio.synthesis.AmplitudeModulator;
import imr.sound.audio.synthesis.FrequencyModulator;
import imr.sound.audio.synthesis.RingModulator;
...
_ampMenuItem.addActionListener(new ActionListener()
{
	...
	if(state)
	{
		...
		_ampModulator.setModulatorAmplitude(_modulator.getModulatorAmplitude());
		_ampModulator.setModulatorFrequency(_modulator.getModulatorFrequency());
		_ampModulator.setModulationIndex(_modulator.getModulationIndex());
		...
		_modulator.applyCarrierEnvelope(apply_cenv);
		_modulator.applyModulatorEnvelope(apply_menv);
	}
	else
	{
...
_freqModulator.setCarrierAmplitude(_modulator.getCarrierAmplitude());
		...
		_freqModulator.setModulatorAmplitude(_modulator.getModulatorAmplitude());
				_freqModulator.setModulatorFrequency(_modulator.getModulatorFrequency());
				_freqModulator.setModulationIndex(_modulator.getModulationIndex());
...
_ringModulator.setCarrierAmplitude(_modulator.getCarrierAmplitude());
		...
		_ringModulator.setModulatorAmplitude(_modulator.getModulatorAmplitude());
				_ringModulator.setModulatorFrequency(_modulator.getModulatorFrequency());
				_ringModulator.setModulationIndex(_modulator.getModulationIndex());
...
private boolean apply_cenv;
private boolean apply_menv;
