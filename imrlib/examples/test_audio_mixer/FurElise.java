...
import imr.sound.audio.AudioMixer;
import imr.sound.audio.FrameFactory;
import imr.sound.audio.synthesis.Synthesizer;
import imr.sound.audio.synthesis.MusicalSynthesizer;
...
public FurElise()
{
_wave = new MusicalSynthesizer(1.0f, 65.4f, 44100.0f);
...
((MusicalSynthesizer)_wave).oddHarmonics();
...
((MusicalSynthesizer)_wave).setHarmonicAmplitudes(_wave.getAmplitude()/4.0f, _wave.getAmplitude()/8.0f, _wave.getAmplitude()/16.0f);
_wave.synth(frame);
...
((MusicalSynthesizer)_wave).allHarmonics();
...
((MusicalSynthesizer)_wave).setHarmonicAmplitudes(_wave.getAmplitude()/2.0f, _wave.getAmplitude()/4.0f, _wave.getAmplitude()/8.0f);
_wave.synth(frame);
_track.write(frame, 0, frame.length);
}
