...
import imr.matrix.Matrix;
import imr.matrix.Vector;
import imr.matrix.LinearSystemSolver;
import imr.matrix.LinearSystemSolver.LU;
import imr.matrix.CramerSolver;
import imr.matrix.GaussianSolver;
import imr.matrix.QR;
...
// solve
Vector x = LinearSystemSolver.solve(m);
...
System.out.println();
System.out.println("solution:");
GaussianSolver.solve(m, x).print();
System.out.println();
...
// construct a LinearSystemSolver from a nxn matrix (m1)
LinearSystemSolver solver = new LinearSystemSolver(m1);
...
LinearSystemSolver.LU lu = solver.lu();
...
int[] p = lu.permutations();

// show permutation vector
